...
public class CTDBlockFlowing extends BlockFluidClassic implements ItemModelProvider, BlockRenderRegister
{
	protected String name;
	protected String modid;
	public CTDBlockFlowing(Fluid fluid, Material material, String name, String modid) 
	{
